...
\end{itemize}
Cette baseline sert d'introduction ; le traitement rigoureux (suppression de la
fuite de données, modèles réglés, intervalles conformes, interprétabilité SHAP) est
détaillé au chapitre~\ref{chap:advanced_real}.
